//
//  VCMegapolis2DPatternTransition.swift
//  VideoClap
//
...
open class VCMegapolis2DPatternTransition: NSObject, VCTransitionProtocol {
    ...
    public func transition(renderSize: CGSize, progress: Float, fromImage: CIImage, toImage: CIImage) -> CIImage? {
        ...
        let filter = VCMegapolis2DPatternTransitionFilter()
