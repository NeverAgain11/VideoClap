...
public class VCTimeScaleCollectionView: UICollectionView {
...
extension VCTimeScaleCollectionView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
